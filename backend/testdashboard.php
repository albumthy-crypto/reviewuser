...
<head>
    ...
    :root {
        ...
        /* Indigo 50 */
        --color-primary-hover: #e0e7ff;
        /* Indigo 100 */
        --color-text-dark: #1f2937;
        /* Gray 800/900 for dark text */
    ...
    body {
        ...
        height: 100vh;
        /* CRITICAL: Ensure body fills viewport */
        overflow: hidden;
        /* Prevent body scroll, scrolling is handled by main-content */
    }

    /* Layout Container */
    .app {
        display: block;
        /* Fixed elements dictate the flow */
        height: 100vh;
    }
    ...
    .main-container {
        ...
        flex-direction: column;
        height: 100vh;
        /* Critical: Fixed height for internal scrolling */
        overflow: hidden;
    ...
    .topbar-nav {
        ...
        flex-shrink: 0;
        /* Prevents topbar from shrinking */
    ...
    .main-content {
        ...
        padding: 1.5rem;
        overflow-y: auto;
        /* CRITICAL: Isolates scrolling here */
    ...
    <div id="app-wrapper" class="app">
        ...
        <aside id="sidebar" class="sidebar glass-sidebar">
            ...
            <div class="brand" role="banner">
                <img src="https://placehold.co/40x40/6366f1/ffffff?text=B" alt="Thy Logo" class="logo">
            ...
            <div class="topbar-nav">
                ...
                <div class="user-dropdown-wrapper">
                    <button id="userDropdown" type="button" class="user-dropdown-btn" aria-expanded="false"
                        aria-haspopup="true">
                        Admin User
                        <img class="user-avatar" src="https://placehold.co/32x32/6366f1/ffffff?text=AU"
                            alt="User Avatar">
                    </button>
                    ...
                    <div id="userToggleMenu" class="user-dropdown-menu hidden opacity-0 scale-95" role="menu"
                        ...
                        <div class="menu-section border-t" role="none">
                            <a href="#" class="dropdown-item text-red rounded-b" role="menuitem" onclick="showModal()">
            ...
            <main class="main-content">
                ...
                <div id="overview-view" class="view">
                    ...
                    <div class="activity-log">
                        ...
                        <p class="activity-log-text">This is the default dashboard view containing key metrics and
                            recent activity.</p>
                        <br>
                        <p class="activity-log-text">Scroll Test Content Line 1. This content ensures the main area is
                            long enough to demonstrate that the Navbar and Sidebar remain fixed while this section
                            scrolls.</p>
                        <p class="activity-log-text">Scroll Test Content Line 2. Notice how the top navigation bar
                            sticks firmly to the top of the scrollable area, and the sidebar remains fixed on the left.
                        </p>
                        <p class="activity-log-text">Scroll Test Content Line 3. We use a combination of `height:
                            100vh`, `display: flex`, and `overflow-y: auto` to isolate the scrollbar to this main
                            section.</p>
                        <p class="activity-log-text">Scroll Test Content Line 4. This ensures a clean user experience
                            without multiple scrollbars.</p>
                        <p class="activity-log-text">Scroll Test Content Line 5. Keep scrolling to see the full effect.
                        </p>
                        ...
                        <p class="activity-log-text">Scroll Test Content Line 20. End of scroll test content.</p>
                    </div>
                </div>
                ...
                <div id="users-view" class="view hidden">
                    <div
                        ...
                        <h3
                            ...
                            User Management</h3>
                        <p style="color: var(--color-text-medium);">This page is intentionally left blank for you to add
                            user tables or management forms.</p>
                    </div>
                </div>
                ...
                <div id="generic-view" class="view hidden">
                    <div
                        ...
                        <p style="color: var(--color-text-medium);">Content for this administrative section (Reports,
